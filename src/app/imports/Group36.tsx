  ...
  return (
    <div className="relative size-full">
      <div className="absolute contents left-0 top-0">
        ...
        <p className="-translate-x-1/2 absolute font-['Poppins:Regular',sans-serif] leading-[normal] left-[181.5px] not-italic text-[20px] text-center text-white top-[5px] whitespace-nowrap">Calcular dosis de insulina con IA</p>
      </div>
