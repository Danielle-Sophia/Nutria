import svgPaths from "./svg-1uuvije8uq";
...
function Group() {
  return (
    <div className="absolute contents left-[780px] top-[312px]">
      <div className="absolute bg-[#e1e9f2] h-[49px] left-[780px] rounded-[50px] top-[312px] w-[502px]" />
      <div className="absolute left-[1234px] overflow-clip size-[20px] top-[326px]" data-name="Search">
        <div className="absolute inset-[12.5%]" data-name="Icon">
          <div className="absolute inset-[-13.33%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
              <path d={svgPaths.p2b93ef40} id="Icon" stroke="var(--stroke-0, #303030)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
            </svg>
          </div>
        </div>
      </div>
...
export default function MisPacientesInicio() {
  return (
    <div className="bg-[#85aab3] relative size-full" data-name="Mis pacientes - inicio">
      ...
      <div className="absolute left-[949px] overflow-clip size-[30px] top-[566px]" data-name="Phone">
        <div className="absolute inset-[8.33%_8.33%_8.63%_8.8%]" data-name="Icon">
          <div className="absolute inset-[-8.03%_-8.04%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.8609 28.9103">
              <path d={svgPaths.p3e433b00} id="Icon" stroke="var(--stroke-0, #1E1E1E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
            </svg>
          </div>
        </div>
      </div>
      <div className="absolute left-[949px] overflow-clip size-[30px] top-[505px]" data-name="Phone">
        <div className="absolute inset-[8.33%_8.33%_8.63%_8.8%]" data-name="Icon">
          <div className="absolute inset-[-8.03%_-8.04%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.8609 28.9103">
              <path d={svgPaths.p3e433b00} id="Icon" stroke="var(--stroke-0, #1E1E1E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
      ...
      <div className="absolute left-[949px] overflow-clip size-[30px] top-[627px]" data-name="Phone">
        <div className="absolute inset-[8.33%_8.33%_8.63%_8.8%]" data-name="Icon">
          <div className="absolute inset-[-8.03%_-8.04%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.8609 28.9103">
              <path d={svgPaths.p3e433b00} id="Icon" stroke="var(--stroke-0, #1E1E1E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
      ...
      <div className="absolute left-[949px] overflow-clip size-[30px] top-[688px]" data-name="Phone">
        <div className="absolute inset-[8.33%_8.33%_8.63%_8.8%]" data-name="Icon">
          <div className="absolute inset-[-8.03%_-8.04%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.8609 28.9103">
              <path d={svgPaths.p3e433b00} id="Icon" stroke="var(--stroke-0, #1E1E1E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
      ...
      <div className="absolute left-[949px] overflow-clip size-[30px] top-[749px]" data-name="Phone">
        <div className="absolute inset-[8.33%_8.33%_8.63%_8.8%]" data-name="Icon">
          <div className="absolute inset-[-8.03%_-8.04%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.8609 28.9103">
              <path d={svgPaths.p3e433b00} id="Icon" stroke="var(--stroke-0, #1E1E1E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
      ...
      <div className="absolute left-[949px] overflow-clip size-[30px] top-[810px]" data-name="Phone">
        <div className="absolute inset-[8.33%_8.33%_8.63%_8.8%]" data-name="Icon">
          <div className="absolute inset-[-8.03%_-8.04%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.8609 28.9103">
              <path d={svgPaths.p3e433b00} id="Icon" stroke="var(--stroke-0, #1E1E1E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
      ...
      <div className="absolute left-[949px] overflow-clip size-[30px] top-[871px]" data-name="Phone">
        <div className="absolute inset-[8.33%_8.33%_8.63%_8.8%]" data-name="Icon">
          <div className="absolute inset-[-8.03%_-8.04%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.8609 28.9103">
              <path d={svgPaths.p3e433b00} id="Icon" stroke="var(--stroke-0, #1E1E1E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
      ...
      <div className="absolute border-[0.5px] border-black border-solid h-[55px] left-[159px] rounded-[50px] top-[492px] w-[1129px]" />
      <div className="absolute border-[0.5px] border-black border-solid h-[55px] left-[159px] rounded-[50px] top-[553px] w-[1129px]" />
      <div className="absolute border-[0.5px] border-black border-solid h-[55px] left-[159px] rounded-[50px] top-[614px] w-[1129px]" />
      <div className="absolute border-[0.5px] border-black border-solid h-[55px] left-[159px] rounded-[50px] top-[675px] w-[1129px]" />
      <div className="absolute border-[0.5px] border-black border-solid h-[55px] left-[159px] rounded-[50px] top-[736px] w-[1129px]" />
      <div className="absolute border-[0.5px] border-black border-solid h-[55px] left-[159px] rounded-[50px] top-[797px] w-[1129px]" />
      <div className="absolute border-[0.5px] border-black border-solid h-[55px] left-[159px] rounded-[50px] top-[858px] w-[1129px]" />
      <div className="absolute left-[794px] size-[37px] top-[501px]" data-name="Letter">
        <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgLetter} />
      </div>
      <div className="absolute left-[794px] size-[37px] top-[562px]" data-name="Letter">
        <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgLetter} />
      </div>
      <div className="absolute left-[794px] size-[37px] top-[684px]" data-name="Letter">
        <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgLetter} />
      </div>
      <div className="absolute left-[794px] size-[37px] top-[745px]" data-name="Letter">
        <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgLetter} />
      </div>
      <div className="absolute left-[794px] size-[37px] top-[806px]" data-name="Letter">
        <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgLetter} />
      </div>
      <div className="absolute left-[794px] size-[37px] top-[867px]" data-name="Letter">
        <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgLetter} />
      </div>
      <div className="absolute left-[794px] size-[37px] top-[623px]" data-name="Letter">
        <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgLetter} />
      </div>
    </div>
  );
