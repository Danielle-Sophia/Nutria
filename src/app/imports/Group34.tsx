import svgPaths from "./svg-nkv4xvzc0w";

export default function Group() {
  return (
    <div className="relative size-full">
      <div className="absolute h-[112px] left-0 top-[13.5px] w-[215px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 215 112">
          <path d={svgPaths.p53300} fill="var(--fill-0, #E1E9F2)" id="Rectangle 170" />
        </svg>
      </div>
      <div className="absolute h-[18px] left-[156.5px] top-0 w-[42px]">
        <div className="absolute bottom-1/4 left-[6.7%] right-[6.7%] top-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36.3731 13.5">
            <path d={svgPaths.p23a88800} fill="var(--fill-0, #E1E9F2)" id="Polygon 3" />
          </svg>
        </div>
      </div>
      ...
      <div className="absolute left-[24.5px] size-[24px] top-[80px]" data-name="move_item">
        <div className="absolute inset-[12.5%_0_12.5%_12.5%]" data-name="icon">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 18">
            <path d={svgPaths.p2628f200} fill="var(--fill-0, #1D1B20)" id="icon" />
          </svg>
        </div>
      </div>
