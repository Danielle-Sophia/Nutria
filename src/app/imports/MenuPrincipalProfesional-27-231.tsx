import svgPaths from "./svg-6dk2q0btf9";
...
function Component3() {
  return (
    <div className="absolute h-[262px] left-[1011px] top-[486px] w-[266px]" data-name="Component 4">
      <div className="absolute bg-[#e1e9f2] h-[241px] left-0 rounded-[10px] top-[21px] w-[266px]" />
      <Group3 />
      <div className="absolute h-[173px] left-[20px] top-[59px] w-[225px]" data-name="Lifesavers Card ID">
        <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgLifesaversCardId} />
      </div>
    </div>
  );
}
